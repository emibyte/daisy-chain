...
- [x] proper display of due_date (just a number right now thats also not really referenced anymore, its meant to be the number of days from the creation until the deadline, but then i have to calculate that timestamp still)
